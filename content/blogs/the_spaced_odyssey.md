...
A project can easily be broken down into multiple different problems or to-do lists. Some of them may be new to you. Some of them you may already know how to do. But then there are some problems that you know how to solve but don’t want to work on because it is boring and you are lazy (Like, text truncation function or function to read and parse the contents of given input file). For those things, you don't need an API key or an Agentic AI integrated environment to ask the AI to generate the solutions. In such scenarios, I utilized the normal chat AIs. Even before AI, I did the same thing for those problems with Stack Overflow where a lot of ready-to-paste solutions were available.
